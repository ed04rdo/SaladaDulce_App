...
import 'package:salada_dulce_app/item_page/item_card.dart';
    ...
    return Container(
        ...
        child: ListView(
          padding: EdgeInsets.only(
              top: MediaQuery.of(context).size.height * .05, bottom: 0),
          scrollDirection: Axis.vertical,
          children: <Widget>[
            Row(
              children: [
                ItemCard("assets/img/categorias/Ensaladas.jpg", "Ensaladas"),
                ItemCard("assets/img/categorias/Baguetts.jpg", "Baguetts"),
              ],
            ),
            ItemCard("assets/img/categorias/Cuernitos.jpg", "Cuernitos"),
            ItemCard("assets/img/categorias/Hamburguesas.jpg", "Hamburguesas"),
            ItemCard("assets/img/categorias/Agregados.jpg", "Agregados"),
            ItemCard("assets/img/categorias/Fuertes.jpg", "Fuertes"),
            ItemCard("assets/img/categorias/Bebidas.jpg", "Bebidas"),
            ItemCard("assets/img/categorias/Postres.jpg", "Postres")
          ],
        ));
  }
}
